...
$sql = "SELECT * FROM transaction_book_tbl ;";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM transaction_book_tbl  where transaction_no ='$query' or transaction_date='$query' or amount_type='$query' ";
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">transaction no</th>
                                ...
                                <th scope="col" class="px-6 py-3">amount type</th>
                                <th scope="col" class="px-6 py-3">credit amount</th>
                                <th scope="col" class="px-6 py-3">debit amount</th>
                                <th scope="col" class="px-6 py-3">particulers given to</th>
                                <th scope="col" class="px-6 py-3">site</th>
                                <th scope="col" class="px-6 py-3">main head</th>
                                <th scope="col" class="px-6 py-3">sub head</th>
                                <th scope="col" class="px-6 py-3">bill cheque no</th>
                                <th scope="col" class="px-6 py-3">invoice dated</th>
                                <th scope="col" class="px-6 py-3">invoice no</th>
                                <th scope="col" class="px-6 py-3">gst no</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['debit_amount'] ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php echo $row['particulers_given_to'] ?>
                                    </td>
