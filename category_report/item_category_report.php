...
$sql = "SELECT *,b.name as subCatname	  FROM for_office.itemmastercategory a join for_office.sub_category b on a.categoryId = b.catId 
JOIN for_office.requireattributeforcatname c on b.subCatId= c.SubcatId  order by b.subcatid asc;";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "
        SELECT * 
        FROM for_office.itemmastercategory a 
        JOIN for_office.sub_category b ON a.categoryId = b.categoryId 
        JOIN for_office.requireattributeforcatname c ON b.categoryId = c.SubcatId 
        WHERE a.categoryId = '$query' OR a.category_name = '$query'
        ";
                    ...
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Category id</th>
                                ...
                                <th scope="col" class="px-6 py-3">Subcategori id</th>
                                <th scope="col" class="px-6 py-3">Sub categeory name</th>
                                <th scope="col" class="px-6 py-3">Attr_id</th>
