...
$sql = "SELECT * FROM query_information ;";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM query_information  where id ='$query' or assigned_to ='$query' or query_start_date='$query' ";
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">id</th>
                                ...
                                <th scope="col" class="px-6 py-3">follow up reminder in days</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['follow_up_reminder_in_days'] ?>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['tentative_installation_date'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['tentative_install_delivery_date'] ?>
                                    </td>
