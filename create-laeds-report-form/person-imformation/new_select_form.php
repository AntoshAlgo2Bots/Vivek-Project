...
$conn=mysqli_connect("localhost","root","","create_laeds_form") or die("connection failed");
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM person_information  where record ='$query' or created_by ='$query' or create_date='$query' ";
...
<head>
    ...
    <title>Cretion Laeds Report</title>
</head>
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">record</th>
                                ...
                                <th scope="col" class="px-6 py-3">stauts</th>
                                <th scope="col" class="px-6 py-3">lead source</th>
                                <th scope="col" class="px-6 py-3">ref by</th>
                                <th scope="col" class="px-6 py-3">ref phone no</th>
                                <th scope="col" class="px-6 py-3">lead type</th>
                                <th scope="col" class="px-6 py-3">contect preson name</th>
                                <th scope="col" class="px-6 py-3">contect preson phone no</th>
                                <th scope="col" class="px-6 py-3">contect preson email</th>
                                <th scope="col" class="px-6 py-3">contect preson address</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['contect_preson_name'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['contect_preson_phone_no'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['contect_preson_email'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['contect_preson_address'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['lead_receiving_date'] ?>
                                    </td>
