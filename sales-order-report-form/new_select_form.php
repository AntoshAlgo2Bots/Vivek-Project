...
$sql = "SELECT * FROM sales_oreder_report";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM sales_oreder_report  where username ='$query' or address='$query' or phone='$query' ";
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">Username</th>
                                ...
                                <th scope="col" class="px-6 py-3">installation</th>
                                <th scope="col" class="px-6 py-3">date</th>
                                <th scope="col" class="px-6 py-3">tentative</th>
                                <th scope="col" class="px-6 py-3">perform</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['tentative'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['perform'] ?>
                                    </td>
