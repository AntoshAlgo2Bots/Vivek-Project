...
<head>
    ...
    <div id="create_section" class="mt-5 border border-gray-900 p-5 rounded-lg mx-5">
        ...
        <div class="flex">
            ...
            <form class="w-full border border-gray-500 p-3 rounded-md" id="formData">
                <div class="">
                    <div class="flex justify-between flex-wrap">
                        ...
                        <div class="">
                            <label
                                ...
                                Name : </label>
                            <input type="text" name="short_discription"
                                class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                        <div class="">
                            <label
                                class="block w-36 mb-2 font-bold text-xs font-medium text-gray-900 dark:text-white">Created
                                Date
                                : </label>
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-wrap items-center justify-between">
                <div class="ml-2">
                    ...
                    <input type="text" name="header_id" id="email"
                ...
                <div class="ml-2">
                    ...
                    <input type="text" name="Warehouse" id="email"
   ...
   <script>
        $(document).ready(function () {
            $('#formData').submit(function (e) {
                ...
                $.post("actionAslCreateForm.php", frmData, function (response) {
