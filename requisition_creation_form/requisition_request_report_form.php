...
$sql = "SELECT * FROM requisition_request_form ";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM requisition_request_form  WHERE record_number ='$query' or created_by='$query' or created_date='$query' ";
...
<head>
    ...
    <title>Requisition Request Report Form</title>
</head>
