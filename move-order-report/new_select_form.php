...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM move_order_report_tbl  where record_id ='$query' or description='$query' or move_order_type='$query' ";
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">record id</th>
                                ...
                                <th scope="col" class="px-6 py-3">move order type</th>
                                <th scope="col" class="px-6 py-3">transaction type</th>
                                <th scope="col" class="px-6 py-3">location</th>
                                <th scope="col" class="px-6 py-3">source sub inventory</th>
                                <th scope="col" class="px-6 py-3">destination sub inventory</th>
                                <th scope="col" class="px-6 py-3">date required subinv</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['source_sub_inventory'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['destination_sub_inventory'] ?>
                                    </td>

                                    <td class="px-6 py-4">
                                        <?php echo $row['date_required_subinv'] ?>
                                    </td>
