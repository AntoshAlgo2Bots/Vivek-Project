...
LEFT JOIN employee_info_line b ON a.name = b.name";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM employee_head a inner JOIN employee_info_line b ON
 a.name=b.name where a.name ='$query'  or a.dob='$query'  ";
...
<head>
    ...
    <title>Create employee Report</title>
</head>
                ...
                <div class="overflow-x-auto">
                    ...
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">employee_id</th>
                                <th scope="col" class="px-6 py-3">Name</th>
                                <th scope="col" class="px-6 py-3">DOB</th>
                                <th scope="col" class="px-6 py-3">Department</th>
                                <th scope="col" class="px-6 py-3">Mobile No</th>
                                <th scope="col" class="px-6 py-3">Address </th>
                                <th scope="col" class="px-6 py-3">E-mail Address</th>
                                <th scope="col" class="px-6 py-3">Pan Card Number</th>
                                <th scope="col" class="px-6 py-3">Choose Image</th>
                                ...
                                <th scope="col" class="px-6 py-3">joiner_new_old </th>
                                <th scope="col" class="px-6 py-3">name</th>
                                <th scope="col" class="px-6 py-3">old_organization_name</th>
                                <th scope="col" class="px-6 py-3">deputed_to_location No</th>
                                <th scope="col" class="px-6 py-3">last_ctc </th>
                                <th scope="col" class="px-6 py-3">current_ctc</th>
                                <th scope="col" class="px-6 py-3">temp</th>
                                <th scope="col" class="px-6 py-3">tentative_date_of_joining</th>
                                <th scope="col" class="px-6 py-3">exact_date_of_joining</th>
                                <th scope="col" class="px-6 py-3">notice_period</th>
                                <th scope="col" class="px-6 py-3">notice_served</th>
                                
                                <th scope="col" class="px-6 py-3">job_role </th>
                                <th scope="col" class="px-6 py-3">job_description</th>
                                <th scope="col" class="px-6 py-3">date_anniversary</th>
                                <th scope="col" class="px-6 py-3">offer_later_release_date</th>
                                <th scope="col" class="px-6 py-3">date_of_leaving</th>
                                <th scope="col" class="px-6 py-3">offer_letter_path </th>
                                <th scope="col" class="px-6 py-3">leave_letter_path</th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['offer_letter_path'] ?>
                                    </td>
                                    
                                    <td class="px-6 py-4">
                                        <?php echo $row['leave_letter_path'] ?>
                                    </td>
