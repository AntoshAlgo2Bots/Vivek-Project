...
if ($_SERVER['REQUEST_METHOD']) {
    ...
    `mode_of_transport`, `vehicle_number`, `recieved_by`, `remarks`, `po_number`,`vendor_name`,`received_date`,`received_time`,`item_name`,`finish`,`dimension`,`box_detail`,`checked_by`,`approved_by`) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

        $stmt->bind_param("sissssssss", $invoice_number, $no_of_boxes, $frightCharge, $weight, $datetime, $mode_of_transport, $vehicle_number, $recieved_by, $remarks, $po_number, $vendor_name, $received_date, $received_time, $item_name, $finish, $dimension, $box_detail, $checked_by, $approved_by);
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="vendor_name" id="vendor_name" placeholder="Vendor Name"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $vendor_name : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="received_date" id="received_date" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $received_date : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="received_time" id="received_time" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $received_time : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="item_name" id="item_name" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $item_name : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="finish" id="finish" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $finish : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="dimension" id="dimension" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $dimension : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="box_detail" id="box_detail" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $box_detail : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="checked_by" id="checked_by" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $checked_by : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" <?php echo isset($_POST["gateentryform"]) ? "disabled" : ""; ?>
                                    name="approved_by" id="approved_by" placeholder="Remarks"
                                    value="<?php echo isset($_POST["gateentryform"]) ? $approved_by : ""; ?>"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
