                    ...
                    <div class="flex justify-between flex-wrap mt-3 ">
                        ...
                        <div class="">
                            <label
                                ...
                                Date : </label>
                            <input type="date" name="created_data" id="created_data"
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 border border-gray-700  my-5">
                ...
                <tbody>
                    <!-- <tr class="bg-white border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <input type="text" name="percentage" id="percentages" >
        ...
        $('#search').click(function (e) {
            ...
            $.post("action_searchForm.php", { srch }, function (data) {
                ...
                if (data.success) {
                    ...
                    $("#revision").val(data.data.revision || '');
                    $("#percentage").val(data.data.percentage || '');
                    $("#products").val(data.data.products || '');
                    $("#created_data").val(data.data.created_data || '');
                    $("#created_by").val(data.data.created_by || '');
                    $("#organizin_mapping").val(data.data.organizin_mapping || '');
                    $("#wharehouse_").val(data.data.wharehouse_ || '');
                    ...
                    $("#percentages").val(data.data.percentage || '');
